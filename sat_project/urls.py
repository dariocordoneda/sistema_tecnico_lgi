...
# Importamos las funciones de la app gestion
from gestion.views import (
    ...
    editar_repuesto,
    eliminar_registro_reporte # Ahora sí está importada correctamente
)
...
# Servir archivos multimedia (fotos de los equipos)
if settings.DEBUG:
